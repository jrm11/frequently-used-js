...
window.onload = function () {
    ...
    var userName = $("userName"),pwd = $("pwd"),pwd2 = $("pwd2"),
     email = $("email"),mobile = $("mobile"),ck = $("ck"),btn = $("btn");
    ...
    mobile.onkeyup = mobile.onfocus = mobile.onblur = function (event) {
    ...
    function checkMobile(_e) {
        ...
        } else if (regs.phoneReg.test(val)) {
            box.className = 'box right';
            tip.className = 'tip hide';
            return true;
        } else {
    ...
    email.onfocus = email.onblur = email.onkeyup = function (event) {
        var e = event || window.event;
        checkEmail(e);
    };
    ...
    function checkEmail(_e) {
        ...
        if (val == '') {
            box.className = 'box error';
            tip.className = 'tip error';
            span.className = '邮箱不能为空';
            return false;
        } else if (regs.emailReg.test(val)) {
            box.className = 'box right';
            tip.className = 'tip hide';
        } else {
            box.className = "box error";
